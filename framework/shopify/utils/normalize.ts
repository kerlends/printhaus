...
type NormalizedProductVariants = ReturnType<typeof normalizeProductVariants>;
type NormalizedProductImages = ReturnType<typeof normalizeProductImages>;

export type NormalizedProduct = Omit<Product, 'variants' | 'images'> & {
	variants: NormalizedProductVariants;
